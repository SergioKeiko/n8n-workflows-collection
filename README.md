...
| [0019-EscrituraJSONBinario.json](organized_workflows/uncategorized/0019-EscrituraJSONBinario.json) | Automated workflow for business automation | Simple (3 nodes) | Standard |
...
**[📖 View all 78 workflows →](organized_workflows/customer-support/README.md)**
...
| Workflow | Description | Complexity | Integrations |
|----------|-------------|------------|--------------|
| [0041-filemaker-multi-step.json](organized_workflows/integrations-api/0041-filemaker-multi-step.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0075-syncro-opsgenie-integration.json](organized_workflows/integrations-api/0075-syncro-opsgenie-integration.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0113-webhook-html-response.json](organized_workflows/integrations-api/0113-webhook-html-response.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0173-sinonimos_aleman_openthesaurus_api.json](organized_workflows/integrations-api/0173-sinonimos_aleman_openthesaurus_api.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0176-weather-api.json](organized_workflows/integrations-api/0176-weather-api.json) | Automated workflow for business automation | Simple (3 nodes) | Standard |
| [0200-users-api-spreadsheet.json](organized_workflows/integrations-api/0200-users-api-spreadsheet.json) | Automated workflow for business automation | Medium (6 nodes) | Google Sheets |
| [0249-zendesk-github-integration.json](organized_workflows/integrations-api/0249-zendesk-github-integration.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0333-bored-api-activity-tool.json](organized_workflows/integrations-api/0333-bored-api-activity-tool.json) | Automated workflow for business automation | High (18 nodes) | OpenAI |
| [0373-nasa-api-credentials.json](organized_workflows/integrations-api/0373-nasa-api-credentials.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0385-convertapi-docx2pdf.json](organized_workflows/integrations-api/0385-convertapi-docx2pdf.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0390-convertapi-xlsx-to-pdf-test.json](organized_workflows/integrations-api/0390-convertapi-xlsx-to-pdf-test.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0396-convertapi-jpg-to-pdf.json](organized_workflows/integrations-api/0396-convertapi-jpg-to-pdf.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0397-convertapi-pdf-conversion.json](organized_workflows/integrations-api/0397-convertapi-pdf-conversion.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0420-xero-webhook-verifier.json](organized_workflows/integrations-api/0420-xero-webhook-verifier.json) | Automated workflow for business automation | Medium (11 nodes) | Standard |
| [0462-n8n-blueprint-backoff.json](organized_workflows/integrations-api/0462-n8n-blueprint-backoff.json) | Automated workflow for business automation | Medium (8 nodes) | Google Sheets |

**[📖 View all 72 workflows →](organized_workflows/integrations-api/README.md)**
...
| Workflow | Description | Complexity | Integrations |
|----------|-------------|------------|--------------|
| [0008-notion_linkedin_pub.json](organized_workflows/lead-generation/0008-notion_linkedin_pub.json) | Automated workflow for business automation | Medium (13 nodes) | LinkedIn |
| [0010-crm-lead-batchdata-calification.json](organized_workflows/lead-generation/0010-crm-lead-batchdata-calification.json) | Automated workflow for lead management | High (17 nodes) | Slack |
| [0026-linkedin-top-sourcer.json](organized_workflows/lead-generation/0026-linkedin-top-sourcer.json) | Automated workflow for business automation | High (18 nodes) | Google Sheets, OpenAI |
| [0110-info-uplead-company.json](organized_workflows/lead-generation/0110-info-uplead-company.json) | Automated workflow for lead management | Simple (2 nodes) | Standard |
| [0116-typeform_lead_workflow.json](organized_workflows/lead-generation/0116-typeform_lead_workflow.json) | Automated workflow for lead management | Medium (10 nodes) | Slack |
| [0228-github-fork-to-pipedrive-lead.json](organized_workflows/lead-generation/0228-github-fork-to-pipedrive-lead.json) | Automated workflow for lead management | Medium (8 nodes) | Standard |
| [0308-typeform-whatsapp-message.json](organized_workflows/lead-generation/0308-typeform-whatsapp-message.json) | Automated workflow for lead management | Simple (3 nodes) | Standard |
| [0323-crm_lead_automation.json](organized_workflows/lead-generation/0323-crm_lead_automation.json) | Automated workflow for lead management | Medium (11 nodes) | OpenAI, Email |
| [0342-lead-verification-madkudu-slack.json](organized_workflows/lead-generation/0342-lead-verification-madkudu-slack.json) | Automated workflow for lead management | Medium (11 nodes) | Slack |
| [0346-lead-alertas-n8n.json](organized_workflows/lead-generation/0346-lead-alertas-n8n.json) | Automated workflow for lead management | Medium (8 nodes) | HubSpot, Slack |
| [0499-tts-generation.json](organized_workflows/lead-generation/0499-tts-generation.json) | Automated workflow for business automation | Simple (4 nodes) | Standard |
| [0506-facebook-lead-to-klicktipp.json](organized_workflows/lead-generation/0506-facebook-lead-to-klicktipp.json) | Automated workflow for lead management | Simple (3 nodes) | Standard |
| [0657-linkedin-automation.json](organized_workflows/lead-generation/0657-linkedin-automation.json) | Automated workflow for business automation | Simple (3 nodes) | LinkedIn |
| [0881-github-trending-scraping.json](organized_workflows/lead-generation/0881-github-trending-scraping.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0913-google-maps-leads-generator.json](organized_workflows/lead-generation/0913-google-maps-leads-generator.json) | Automated workflow for lead management | Enterprise (42 nodes) | Google Sheets |

**[📖 View all 53 workflows →](organized_workflows/lead-generation/README.md)**
...
| Workflow | Description | Complexity | Integrations |
|----------|-------------|------------|--------------|
| [0016-todoist-task-creator.json](organized_workflows/project-management/0016-todoist-task-creator.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0039-clickup-task-creator.json](organized_workflows/project-management/0039-clickup-task-creator.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0114-flujo-tareas.json](organized_workflows/project-management/0114-flujo-tareas.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0125-flow-trigger-task.json](organized_workflows/project-management/0125-flow-trigger-task.json) | Automated workflow for business automation | Simple (1 nodes) | Standard |
| [0168-Onfleet-to-QuickBooks-Invoices.json](organized_workflows/project-management/0168-Onfleet-to-QuickBooks-Invoices.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0169-onfleet-task-from-google-drive.json](organized_workflows/project-management/0169-onfleet-task-from-google-drive.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0218-asana-notion-sync.json](organized_workflows/project-management/0218-asana-notion-sync.json) | Automated workflow for business automation | Medium (10 nodes) | Standard |
| [0245-workflow-zendesk-asana.json](organized_workflows/project-management/0245-workflow-zendesk-asana.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0246-monday-mautic-automation.json](organized_workflows/project-management/0246-monday-mautic-automation.json) | Automated workflow for business automation | Simple (3 nodes) | Standard |
| [0330-monday-error-tracking.json](organized_workflows/project-management/0330-monday-error-tracking.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0354-todoist-recurring-tasks.json](organized_workflows/project-management/0354-todoist-recurring-tasks.json) | Automated workflow for business automation | Medium (13 nodes) | Standard |
| [0366-slack-to-clickup-tasks.json](organized_workflows/project-management/0366-slack-to-clickup-tasks.json) | Automated workflow for business automation | Medium (6 nodes) | Standard |
| [0421-alertas-azure-task.json](organized_workflows/project-management/0421-alertas-azure-task.json) | Automated workflow for business automation | Simple (5 nodes) | Standard |
| [0463-add-task-google.json](organized_workflows/project-management/0463-add-task-google.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0468-syncro-clockify-tasks.json](organized_workflows/project-management/0468-syncro-clockify-tasks.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |

**[📖 View all 42 workflows →](organized_workflows/project-management/README.md)**
...
| Workflow | Description | Complexity | Integrations |
|----------|-------------|------------|--------------|
| [0080-shopify-product-alerts.json](organized_workflows/e-commerce/0080-shopify-product-alerts.json) | Automated workflow for business automation | Simple (3 nodes) | Telegram |
| [0081-shopify-pedidos-trigger.json](organized_workflows/e-commerce/0081-shopify-pedidos-trigger.json) | Automated workflow for business automation | Medium (9 nodes) | Email |
| [0082-shopify-reportes-semanal.json](organized_workflows/e-commerce/0082-shopify-reportes-semanal.json) | Automated workflow for business automation | Medium (9 nodes) | Google Sheets, Slack |
| [0140-onfleet-shopify-task.json](organized_workflows/e-commerce/0140-onfleet-shopify-task.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0167-shopify-onfleet-tags-sync.json](organized_workflows/e-commerce/0167-shopify-onfleet-tags-sync.json) | Automated workflow for business automation | Simple (2 nodes) | Standard |
| [0223-stripe-organization-sync.json](organized_workflows/e-commerce/0223-stripe-organization-sync.json) | Automated workflow for business automation | Medium (11 nodes) | Standard |
| [0224-pipedrive-stripe-product-sync.json](organized_workflows/e-commerce/0224-pipedrive-stripe-product-sync.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0240-shopify-zendesk-sync.json](organized_workflows/e-commerce/0240-shopify-zendesk-sync.json) | Automated workflow for business automation | Medium (9 nodes) | Standard |
| [0241-shopify-zendesk-sync.json](organized_workflows/e-commerce/0241-shopify-zendesk-sync.json) | Automated workflow for business automation | Medium (7 nodes) | Standard |
| [0248-shopify-mautic-contact.json](organized_workflows/e-commerce/0248-shopify-mautic-contact.json) | Automated workflow for business automation | Simple (3 nodes) | Standard |
| [0260-woo-product-flow.json](organized_workflows/e-commerce/0260-woo-product-flow.json) | Automated workflow for business automation | Simple (4 nodes) | Standard |
...
| [0154-hubspot-company-alerts.json](organized_workflows/crm-sales/0154-hubspot-company-alerts.json) | Automated workflow for business automation | Simple (5 nodes) | Slack, HubSpot |
